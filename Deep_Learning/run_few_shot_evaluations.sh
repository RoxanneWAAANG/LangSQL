...
# --------------- Few-shot CodeS-1B --------------- #
# Spider's dev (1-shot)
CUDA_VISIBLE_DEVICES=0 python -u text2sql_few_shot.py --llm_path seeklhy/codes-1b --sic_path /home/jack/Projects/yixin-llm/yixin-llm-data/Text2SQL/sic_ckpts/sic_spider --table_num 5 --column_num 6 --dataset_path /home/jack/Projects/yixin-llm/yixin-llm-data/Text2SQL/data/sft_spider_dev_text2sql.json --demonstration_set_path /home/jack/Projects/yixin-llm/yixin-llm-data/Text2SQL/data/sft_spider_train_text2sql.json --num_of_demonstrations 1 --max_tokens 8192 --max_new_tokens 256
